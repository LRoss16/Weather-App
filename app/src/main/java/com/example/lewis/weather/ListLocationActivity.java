    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(null != allLocations){
            for(int i = 0; i < allLocations.size(); i++){
                ...
                System.out.println(allLocations.get(i).getLocation());
                requestJsonObject(allLocations.get(i));
            }
        }

        Toast.makeText(ListLocationActivity.this, allLocations.size() + " locations stored", Toast.LENGTH_LONG).show();
